...
class _UpdateNeedsPageState extends State<UpdateNeedsPage> {
  ...
  void initState() {
    super.initState();
    _currentFulfilledValue = widget.need['fulfilled'] as int;  // Başlangıç değeri 'initState' içinde atanıyor
  }
  ...
  void _saveUpdates() {
    ...
    Navigator.pop(context, {'item': widget.need['item'], 'fulfilled': _currentFulfilledValue});
  }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Item: ${widget.need['item']}', style: TextStyle(fontSize: 24)),
            Text('Required: ${widget.need['needed']}', style: TextStyle(fontSize: 18)),
            Text('Fulfilled: $_currentFulfilledValue', style: TextStyle(fontSize: 18)),
            Slider(
              min: 0,
