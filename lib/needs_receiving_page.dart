...
class _NeedsReceivingPageState extends State<NeedsReceivingPage> {
  final List<Map<String, dynamic>> needs = [
    ...
    {'item': 'Synthetic Thermal Underwear (Adult & Child)', 'needed': 200, 'fulfilled': 100},
    {'item': 'Winter Accessories (Hats, Gloves, Scarves)', 'needed': 400, 'fulfilled': 200},
    {'item': 'Fleece Blankets, Mid-Layers', 'needed': 300, 'fulfilled': 150},
    {'item': 'Winter Boots, Coats, and Raincoats (Adult & Child)', 'needed': 500, 'fulfilled': 250},
    {'item': 'Dry Food Packages', 'needed': 600, 'fulfilled': 300},
    {'item': 'Hygiene and Disinfectant Supplies', 'needed': 800, 'fulfilled': 400},
    {'item': 'Clean Clothes for Adults and Children', 'needed': 700, 'fulfilled': 350},
    {'item': 'Baby Food, Bottles, Pacifiers, Diapers, Feminine Hygiene Products', 'needed': 500, 'fulfilled': 250},
    {'item': 'Power Banks, Hand and Head Lamps, Batteries', 'needed': 400, 'fulfilled': 200},
    {'item': 'Water (0.25 or 0.50 L packs)', 'needed': 1000, 'fulfilled': 500},
  ];

  void _addNewItem() async {
    final Map<String, dynamic>? newNeed = await showDialog<Map<String, dynamic>>(
      context: context,
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              subtitle: Text('Needed: ${need['needed']} - Fulfilled: ${need['fulfilled']}', style: TextStyle(color: Colors.white)),
              ...
              onTap: () async {
                ...
                if (result != null) {
                  setState(() {
                    int index = needs.indexWhere((element) => element['item'] == result['item']);
                    if (index != -1) {
