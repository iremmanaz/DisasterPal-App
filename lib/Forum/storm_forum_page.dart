...
class StormForumPage extends StatefulWidget {
  @override
  _StormForumPageState createState() => _StormForumPageState();
}

class _StormForumPageState extends State<StormForumPage> {
  final TextEditingController _questionController = TextEditingController();
  List<String> questions = [];
  List<List<String>> answers = [];
  List<ForumComment> forumComments = [
    ForumComment("Ali", "Kara", "User",
        "A storm warning has been issued in Ankara.", []),
    ForumComment("Burak", "Yılmaz", "User",
        "The roof of my house flew off in the storm!", []),
    ForumComment("Ceren", "Zorlu", "User", "The storm is so scary!", []),
  ];
            ...
            children: <Widget>[
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Ask a question about storm',
